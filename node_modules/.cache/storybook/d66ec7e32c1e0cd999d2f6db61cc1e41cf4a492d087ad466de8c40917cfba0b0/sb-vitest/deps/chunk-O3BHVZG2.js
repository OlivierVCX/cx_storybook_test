...
// node_modules/storybook/dist/_browser-chunks/chunk-XDGMHOV7.js
...
var _UniversalStore = class _UniversalStore2 {
  constructor(options, environmentOverrides) {
    ...
    this.getState = __name(() => {
      this.debug("getState", { state: this.state });
      return this.state;
    }, "getState");
    this.subscribe = __name((eventTypeOrListener, maybeListener) => {
    ...
    this.send = __name((event) => {
      this.debug("send", { event });
      if (this.status !== _UniversalStore2.Status.READY) {
        throw new TypeError(
    ...
    if (!_UniversalStore2.isInternalConstructing) {
      throw new TypeError(
        "UniversalStore is not constructable - use UniversalStore.create() instead"
      );
    }
    _UniversalStore2.isInternalConstructing = false;
    this.id = options.id;
    this.actorId = Date.now().toString(36) + Math.random().toString(36).substring(2);
    this.actorType = options.leader ? _UniversalStore2.ActorType.LEADER : _UniversalStore2.ActorType.FOLLOWER;
    ...
    if (this.actor.type === _UniversalStore2.ActorType.LEADER) {
      this.syncing = {
    ...
    this.channel = environmentOverrides?.channel ?? _UniversalStore2.preparation.channel;
    this.environment = environmentOverrides?.environment ?? _UniversalStore2.preparation.environment;
    if (this.channel && this.environment) {
      _UniversalStore2.preparation.resolve({ channel: this.channel, environment: this.environment });
      this.prepareThis({ channel: this.channel, environment: this.environment });
    } else {
      _UniversalStore2.preparation.promise.then(this.prepareThis);
    }
  }
  static setupPreparationPromise() {
    ...
    const promise = new Promise(
      (resolve, reject) => {
        resolveRef = __name((args) => {
          resolve(args);
        }, "resolveRef");
        rejectRef = __name((...args) => {
          reject(args);
        }, "rejectRef");
      }
    );
  ...
  static create(options) {
    ...
    const store = new _UniversalStore2(options);
  ...
  static __prepare(channel, environment) {
    _UniversalStore2.preparation.channel = channel;
    _UniversalStore2.preparation.environment = environment;
    _UniversalStore2.preparation.resolve({ channel, environment });
  }
  /**
   ...
   */
  static __reset() {
    _UniversalStore2.preparation.reject(new Error("reset"));
    _UniversalStore2.setupPreparationPromise();
    _UniversalStore2.isInternalConstructing = false;
  }
};
...
var __toESM = __name((mod, isNodeMode, target) => (target = mod != null ? __create(__getProtoOf(mod)) : {}, __copyProps(
...
var require_isNaN = __commonJS({
  "node_modules/.pnpm/math-intrinsics@1.1.0/node_modules/math-intrinsics/isNaN.js"(exports, module) {
    "use strict";
    module.exports = Number.isNaN || __name(function isNaN2(a) {
      return a !== a;
    }, "isNaN2");
  }
});
...
var require_implementation = __commonJS({
  "node_modules/.pnpm/function-bind@1.1.2/node_modules/function-bind/implementation.js"(exports, module) {
    ...
    var concatty = __name(function concatty2(a, b) {
      var arr = [];
    ...
    module.exports = __name(function bind(that) {
      ...
      if (target.prototype) {
        var Empty = __name(function Empty2() {
        }, "Empty2");
...
var require_get = __commonJS({
  "node_modules/.pnpm/dunder-proto@1.0.1/node_modules/dunder-proto/get.js"(exports, module) {
    ...
    module.exports = desc && typeof desc.get === "function" ? callBind([desc.get]) : typeof $getPrototypeOf === "function" ? (
      /** @type {import('./get')} */
      __name(function getDunder(value) {
...
var require_get_proto = __commonJS({
  "node_modules/.pnpm/get-proto@1.0.1/node_modules/get-proto/index.js"(exports, module) {
    ...
    module.exports = reflectGetProto ? __name(function getProto(O) {
      return reflectGetProto(O);
    }, "getProto") : originalGetProto ? __name(function getProto(O) {
      if (!O || typeof O !== "object" && typeof O !== "function") {
        throw new TypeError("getProto: not an object");
      }
      return originalGetProto(O);
    }, "getProto") : getDunderProto ? __name(function getProto(O) {
...
var require_is_regex = __commonJS({
  "node_modules/.pnpm/is-regex@1.2.1/node_modules/is-regex/index.js"(exports, module) {
    ...
    if (hasToStringTag) {
      ...
      fn = __name(function isRegex(value) {
...
var require_safe_regex_test = __commonJS({
  "node_modules/.pnpm/safe-regex-test@1.1.0/node_modules/safe-regex-test/index.js"(exports, module) {
    ...
    var $TypeError = require_type();
    module.exports = __name(function regexTester(regex) {
      if (!isRegex(regex)) {
        throw new $TypeError("`regex` must be a RegExp");
      }
      return __name(function test(s) {
...
var require_is_symbol = __commonJS({
  "node_modules/.pnpm/is-symbol@1.1.1/node_modules/is-symbol/index.js"(exports, module) {
    ...
    if (hasSymbols) {
      ...
      isSymbolObject = __name(function isRealSymbolObject(value) {
        if (typeof value.valueOf() !== "symbol") {
          return false;
        }
        return isSymString($symToStr(value));
      }, "isRealSymbolObject");
      module.exports = __name(function isSymbol3(value) {
...
var isJSON = __name((input) => input.match(/^[\[\{\"\}].*[\]\}\"]$/), "isJSON");
...
var replacer = __name(function replacer2(options) {
  ...
  let stack;
  let keys;
  return __name(function replace(key, value) {
    try {
      if (key === "") {
        keys = [];
...
var reviver = __name(function reviver2(options) {
  const refs = [];
  let root2;
  return __name(function revive(key, value) {
    if (key === "") {
      root2 = value;
...
var mutator = __name(() => {
  ...
  return __name(function mutateUndefined(value) {
    if (isObject3(value)) {
...
var isMulti = __name((args) => {
  return args.transports !== void 0;
}, "isMulti");
var generateRandomId = __name(() => {
  return Math.random().toString(16).slice(2);
}, "generateRandomId");
var _Channel = class _Channel2 {
  constructor(input = {}) {
  ...
  onceListener(eventName, listener) {
    const onceListener = __name((...args) => {
...
var getEventSourceUrl = __name((event) => {
...
var _PostMessageTransport = class _PostMessageTransport2 {
  constructor(config) {
    this.config = config;
...
var _WebsocketTransport = class _WebsocketTransport2 {
...
function createBrowserChannel({ page, extraTransports = [] }) {
  ...
  if (CONFIG_TYPE === "DEVELOPMENT") {
    ...
    transports.push(new WebsocketTransport({ url: channelUrl, onError: __name(() => {
    }, "onError"), page }));
  }
...
//# sourceMappingURL=chunk-O3BHVZG2.js.map
