...
var parseDimension = __name((value, dimension) => {
...
var setViewport = __name(async (parameters = {}, globals = {}) => {
  let defaultViewport;
...
var convertToFilePath = __name((url) => {
  const path = url.replace(/^file:\/\//, "");
  const normalizedPath = path.replace(/^\/+([a-zA-Z]:)/, "$1");
  return normalizedPath.replace(/%20/g, " ");
}, "convertToFilePath");
var testStory = __name((exportName, story, meta, skipTags, storyId, testName) => {
