...
// node_modules/@storybook/vue3/dist/_browser-chunks/chunk-JFJ5UJ7Q.js
...
// node_modules/@storybook/vue3/dist/_browser-chunks/chunk-GZHEVVQL.js
...
var extractArgTypes = __name((component) => {
...
var extractFromVueDocgenApi = __name((docgenInfo, section, extractedProp) => {
  let type;
  let sbType;
  if (section === "events") {
  ...
  if (section === "props") {
    ...
    sbType = extractedProp ? convert4(extractedProp.docgenInfo) : { name: "other", value: type };
...
var extractFromVueComponentMeta = __name((docgenInfo, section) => {
...
var convertVueComponentMetaProp = __name((propInfo) => {
...
var formatDescriptionWithTags = __name((description, tags) => {
...
var runSetupFunctions = __name(async (app, storyContext) => {
...
function decorateStory(storyFn, decorators) {
  return decorators.reduce(
    (decorated, decorator) => (context) => {
      ...
      const innerStory = __name(() => h(story), "innerStory");
...
// node_modules/@storybook/vue3/dist/index.js
...
__name(setProjectAnnotations2, "setProjectAnnotations");
var vueProjectAnnotations = {
  ...entry_preview_exports,
  /** @deprecated */
  renderToCanvas: __name((renderContext, canvasElement) => {
    if (renderContext.storyContext.testingLibraryRender == null) {
      return renderToCanvas(renderContext, canvasElement);
    }
    const {
      storyFn,
      storyContext: { testingLibraryRender: render2 }
    } = renderContext;
    const { unmount } = render2(storyFn(), { container: canvasElement });
    return unmount;
  }, "renderToCanvas")
};
function composeStory2(story, componentAnnotations, projectAnnotations, exportsName) {
  ...
  const renderable = __name((...args) => h(composedStory(...args)), "renderable");
  Object.assign(renderable, composedStory);
  return renderable;
}
__name(composeStory2, "composeStory");
function composeStories2(csfExports, projectAnnotations) {
  const composedStories = composeStories(csfExports, projectAnnotations, composeStory2);
  return composedStories;
}
__name(composeStories2, "composeStories");
export {
...
//# sourceMappingURL=@storybook_vue3-vite.js.map
