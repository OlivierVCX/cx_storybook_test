...
import {
  ...
  STORY_ARGS_UPDATED,
  UPDATE_STORY_ARGS
} from "./chunk-O3BHVZG2.js";
import {
  ActionBar
} from "./chunk-ERZNA3OE.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
var DocsContext2 = globalThis ? globalThis.__DOCS_CONTEXT__ : (0, import_react6.createContext)(null);
...
var Story2 = __name((props = { __forceInitialArgs: false, __primary: false }) => {
  const context = (0, import_react7.useContext)(DocsContext2);
...
var Preview2 = __name(({
  ...
  const context = (0, import_react5.useContext)(DocsContext2);
  const copyToClipboard = (0, import_react5.useCallback)(async (text) => {
    const { createCopyToClipboardFunction } = await import("./components-Y4UNNGAM.js");
...
var StyledPreview = styled(Preview2)(() => ({
  ".docs-story": {
    paddingTop: 32,
    paddingBottom: 40
  }
...
function qe(e2, n2) {
  ...
  return { t: __name((e3) => a2.test(e3), "t"), o: je(function(e3, n3) {
...
__name(Ne, "Ne");
var Ge = __name((e2, n2, r2) => ({ children: Pe(n2, e2[2], r2) }), "Ge");
function Ue() {
  return {};
}
__name(Ue, "Ue");
...
function We(r2 = "", t = {}) {
  ...
  } }, 1: { t: ["  "], o: Me(d), i: 1, u: Ue, l: __name((e2, n2, r3) => W2("br", { key: r3.key }), "l") }, 2: { t: ["--", "__", "**", "- ", "* ", "_ "], o: Te(p), i: 1, u: Ue, l: __name((e2, n2, r3) => W2("hr", { key: r3.key }), "l") }, 3: { t: ["    "], o: Te(h), i: 0, u: __name((e2) => ({ lang: void 0, text: Fe(Se(e2[0].replace(/^ {4}/gm, ""))) }), "u"), l: __name((e2, r3, t2) => W2("pre", { key: t2.key }, W2("code", n({}, e2.attrs, { className: e2.lang ? "lang-" + e2.lang : "" }), e2.text)), "l") }, 4: { t: ["```", "~~~"], o: Te(y), i: 0, u: __name((e2) => ({ attrs: ce2("code", e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: "3" }), "u") }, 5: { t: ["`"], o: Ie(g), i: 3, u: __name((e2) => ({ text: Fe(e2[2]) }), "u"), l: __name((e2, n2, r3) => W2("code", { key: r3.key }, e2.text), "l") }, 6: { t: ["[^"], o: Te(x), i: 0, u: __name((e2) => (ie2.push({ footnote: e2[2], identifier: e2[1] }), {}), "u"), l: Ve }, 7: { t: ["[^"], o: Ce(q), i: 1, u: __name((e2) => ({ target: "#" + l2(e2[1], Ae), text: e2[1] }), "u"), l: __name((e2, n2, r3) => W2("a", { key: r3.key, href: G2(e2.target, "a", "href") }, W2("sup", { key: r3.key }, e2.text)), "l") }, 8: { t: ["[ ]", "[x]"], o: Ce($), i: 1, u: __name((e2) => ({ completed: "x" === e2[1].toLowerCase() }), "u"), l: __name((e2, n2, r3) => W2("input", { checked: e2.completed, key: r3.key, readOnly: true, type: "checkbox" }), "l") }, 9: { t: ["#"], o: Te(t.enforceAtxHeadings ? z : S), i: 1, u: __name((e2, n2, r3) => ({ children: Pe(n2, e2[2], r3), id: l2(e2[2], Ae), level: e2[1].length }), "u"), l: __name((e2, n2, r3) => W2("h" + e2.level, { id: e2.id, key: r3.key }, n2(e2.children, r3)), "l") }, 10: { t: __name((e2) => {
    const n2 = e2.indexOf("\n");
    return n2 > 0 && n2 < e2.length - 1 && ("=" === e2[n2 + 1] || "-" === e2[n2 + 1]);
  }, "t"), o: Te(E), i: 1, u: __name((e2, n2, r3) => ({ children: Pe(n2, e2[1], r3), level: "=" === e2[2] ? 1 : 2, type: "9" }), "u") }, 11: { t: ["<"], o: Me(A), i: 1, u(e2, n2, r3) {
  ...
  }, l: __name((e2, r3, t2) => W2(e2.tag, n({ key: t2.key }, e2.attrs), e2.text || (e2.children ? r3(e2.children, t2) : "")), "l") }, 13: { t: ["<"], o: Me(O), i: 1, u(e2) {
    const n2 = e2[1].trim();
    return { attrs: ce2(n2, e2[2] || ""), tag: n2 };
  }, l: __name((e2, r3, t2) => W2(e2.tag, n({}, e2.attrs, { key: t2.key })), "l") }, 12: { t: ["<!--"], o: Me(B), i: 1, u: __name(() => ({}), "u"), l: Ve }, 14: { t: ["!["], o: Ie(be), i: 1, u: __name((e2) => ({ alt: Fe(e2[1]), target: Fe(e2[2]), title: Fe(e2[3]) }), "u"), l: __name((e2, n2, r3) => W2("img", { key: r3.key, alt: e2.alt || void 0, title: e2.title || void 0, src: G2(e2.target, "img", "src") }), "l") }, 15: { t: ["["], o: Ce(ve), i: 3, u: __name((e2, n2, r3) => ({ children: Ze(n2, e2[1], r3), target: Fe(e2[2]), title: Fe(e2[3]) }), "u"), l: __name((e2, n2, r3) => W2("a", { key: r3.key, href: G2(e2.target, "a", "href"), title: e2.title }, n2(e2.children, r3)), "l") }, 16: { t: ["<"], o: Ce(I), i: 0, u(e2) {
  ...
  } }, 17: { t: __name((e2, n2) => !n2.inAnchor && !t.disableAutoLink && (ze(e2, "http://") || ze(e2, "https://")), "t"), o: Ce(C), i: 0, u: __name((e2) => ({ children: [{ text: e2[1], type: "27" }], target: e2[1], title: void 0, type: "15" }), "u") }, 20: qe(W2, 1), 33: qe(W2, 2), 19: { t: ["\n"], o: Te(m), i: 3, u: Ue, l: __name(() => "\n", "l") }, 21: { o: je(function(e2, n2) {
  ...
  }), i: 3, u: Ge, l: __name((e2, n2, r3) => W2("p", { key: r3.key }, n2(e2.children, r3)), "l") }, 22: { t: ["["], o: Ce(D), i: 0, u: __name((e2) => (ue2[e2[1]] = { target: e2[2], title: e2[4] }, {}), "u"), l: Ve }, 23: { t: ["!["], o: Ie(F), i: 0, u: __name((e2) => ({ alt: e2[1] ? Fe(e2[1]) : void 0, ref: e2[2] }), "u"), l: __name((e2, n2, r3) => ue2[e2.ref] ? W2("img", { key: r3.key, alt: e2.alt, src: G2(ue2[e2.ref].target, "img", "src"), title: ue2[e2.ref].title }) : null, "l") }, 24: { t: __name((e2) => "[" === e2[0] && -1 === e2.indexOf("]("), "t"), o: Ce(P), i: 0, u: __name((e2, n2, r3) => ({ children: n2(e2[1], r3), fallbackChildren: e2[0], ref: e2[2] }), "u"), l: __name((e2, n2, r3) => ue2[e2.ref] ? W2("a", { key: r3.key, href: G2(ue2[e2.ref].target, "a", "href"), title: ue2[e2.ref].title }, n2(e2.children, r3)) : W2("span", { key: r3.key }, e2.fallbackChildren), "l") }, 25: { t: ["|"], o: Te(M), i: 1, u: Le, l(e2, n2, r3) {
    const t2 = e2;
  ...
  }, l: __name((e2) => e2.text, "l") }, 28: { t: ["**", "__"], o: Ie(J), i: 2, u: __name((e2, n2, r3) => ({ children: n2(e2[2], r3) }), "u"), l: __name((e2, n2, r3) => W2("strong", { key: r3.key }, n2(e2.children, r3)), "l") }, 29: { t: __name((e2) => {
    const n2 = e2[0];
    return ("*" === n2 || "_" === n2) && e2[1] !== n2;
  }, "t"), o: Ie(K), i: 3, u: __name((e2, n2, r3) => ({ children: n2(e2[2], r3) }), "u"), l: __name((e2, n2, r3) => W2("em", { key: r3.key }, n2(e2.children, r3)), "l") }, 30: { t: ["\\"], o: Ie(ne), i: 1, u: __name((e2) => ({ text: e2[1], type: "27" }), "u") }, 31: { t: ["=="], o: Ie(X), i: 3, u: Ge, l: __name((e2, n2, r3) => W2("mark", { key: r3.key }, n2(e2.children, r3)), "l") }, 32: { t: ["~~"], o: Ie(Y), i: 3, u: Ge, l: __name((e2, n2, r3) => W2("del", { key: r3.key }, n2(e2.children, r3)), "l") } };
  ...
  })(le2), fe2 = (function(e2, n2) {
    return __name(function r3(t2, o2 = {}) {
      if (Array.isArray(t2)) {
        const e3 = o2.key, n3 = [];
        let a2 = false;
...
var LazyColorControl = (0, import_react20.lazy)(() => import("./Color-64QXVMR3-EYWRUN3I.js"));
...
var useOf = __name((moduleExportOrType, validTypes) => {
  const context = (0, import_react42.useContext)(DocsContext2);
  return context.resolveOf(moduleExportOrType, validTypes);
}, "useOf");
var titleCase = __name((str) => str.split("-").map((part) => part.charAt(0).toUpperCase() + part.slice(1)).join(""), "titleCase");
...
var Source2 = __name((props) => {
  ...
  const docsContext = (0, import_react44.useContext)(DocsContext2);
...
var Canvas = __name((props) => {
  const docsContext = (0, import_react43.useContext)(DocsContext2);
...
var Controls3 = __name((props) => {
  ...
  const context = (0, import_react47.useContext)(DocsContext2);
...
var AddContext = __name((props) => {
  ...
  const parentContext = import_react52.default.useContext(DocsContext2);
  return import_react52.default.createElement(DocsContext2.Provider, { value: { ...parentContext, ...rest } }, children);
}, "AddContext");
...
var AnchorInPage = __name(({ hash, children }) => {
  const context = (0, import_react52.useContext)(DocsContext2);
  return import_react52.default.createElement(
    A2,
    {
      href: hash,
...
var DocsContainer = __name(({
  ...
  return import_react54.default.createElement(DocsContext2.Provider, { value: context }, import_react54.default.createElement(SourceContainer, { channel: context.channel }, import_react54.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react54.default.createElement(
    DocsPageWrapper,
    {
...
var Primary = __name((props) => {
  ...
  const context = (0, import_react56.useContext)(DocsContext2);
...
var Stories = __name(({ title = "Stories", includePrimary = true }) => {
  const { componentStories, projectAnnotations, getStoryContext } = (0, import_react60.useContext)(DocsContext2);
...
__name(Docs, "Docs");
var _ExternalDocsContext = class _ExternalDocsContext2 extends DocsContext {
...
var ExternalDocsContainer = __name(({ projectAnnotations, children }) => {
  ...
  return import_react64.default.createElement(DocsContext2.Provider, { value: preview.docsContext() }, import_react64.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children));
}, "ExternalDocsContainer");
var Meta = __name(({ of }) => {
  const context = (0, import_react65.useContext)(DocsContext2);
  if (of) {
...
//# sourceMappingURL=chunk-UQD54I5S.js.map
