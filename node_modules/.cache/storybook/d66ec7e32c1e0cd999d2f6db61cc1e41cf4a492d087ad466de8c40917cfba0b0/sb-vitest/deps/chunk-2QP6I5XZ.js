...
var LazySyntaxHighlighter = (0, import_react5.lazy)(async () => {
  const { SyntaxHighlighter: SyntaxHighlighter2 } = await import("./syntaxhighlighter-CAVLW7PM-BULKZGIU.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react5.lazy)(async () => {
  const [{ SyntaxHighlighter: SyntaxHighlighter2 }, { formatter }] = await Promise.all([
    import("./syntaxhighlighter-CAVLW7PM-BULKZGIU.js"),
    import("./formatter-OMEEQ6HG-UZEQBVF7.js")
  ]);
  if (languages.length > 0) {
    languages.forEach((args) => {
      SyntaxHighlighter2.registerLanguage(...args);
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext32(rootComponentName, defaultContext) {
    ...
    const Provider = __name((props) => {
      ...
      const Context = scope2?.[scopeName]?.[index3] || BaseContext;
      const value = React8.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime.jsx)(Context.Provider, { value, children });
    }, "Provider");
    Provider.displayName = rootComponentName + "Provider";
  ...
  const createScope = __name(() => {
    ...
    return __name(function useScope(scope2) {
...
function createSlottable(ownerName) {
  const Slottable22 = __name(({ children }) => {
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React33.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime7.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React33.isValidElement(newElement) ? React33.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var DialogPortal = __name((props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React34.Children.map(children, (child) => (0, import_jsx_runtime8.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime8.jsx)(Portal, { asChild: true, container, children: child }) })) });
}, "DialogPortal");
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React35.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime9.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React35.isValidElement(newElement) ? React35.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var LazyWithTooltip = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-LZPCPVQQ.js").then((mod) => ({ default: mod.WithTooltip }))
);
...
var LazyWithTooltipPure = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-LZPCPVQQ.js").then((mod) => ({ default: mod.WithTooltipPure }))
);
...
//# sourceMappingURL=chunk-2QP6I5XZ.js.map
