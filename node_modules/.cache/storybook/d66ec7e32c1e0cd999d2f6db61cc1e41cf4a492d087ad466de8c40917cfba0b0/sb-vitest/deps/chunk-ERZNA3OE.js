...
var ActionBar = __name(({ actionItems, ...props }) => import_react.default.createElement(Container, { ...props }, actionItems.map(({ title, className, onClick, disabled }, index) => import_react.default.createElement(ActionButton, { key: index, className, onClick, disabled: !!disabled }, title))), "ActionBar");
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      ...
      const Context = scope2?.[scopeName][index] || BaseContext;
...
var ScrollAreaScrollbarHover = React23.forwardRef((props, forwardedRef) => {
  ...
  React23.useEffect(() => {
    ...
    let hideTimer = 0;
    if (scrollArea) {
      const handlePointerEnter = __name(() => {
        window.clearTimeout(hideTimer);
        setVisible(true);
      }, "handlePointerEnter");
      const handlePointerLeave = __name(() => {
...
var ScrollAreaScrollbarImpl = React23.forwardRef((props, forwardedRef) => {
  ...
  React23.useEffect(() => {
    const handleWheel = __name((event) => {
...
var addUnlinkedScrollListener = __name((node, handler = () => {
}) => {
  let prevPosition = { left: node.scrollLeft, top: node.scrollTop };
  let rAF = 0;
  __name(function loop() {
...
var ScrollArea2 = (0, import_react2.forwardRef)(
  ({ children, horizontal = false, vertical = false, offset = 2, scrollbarSize = 6, className }, ref) => import_react2.default.createElement(ScrollAreaRoot, { scrollbarsize: scrollbarSize, offset, className }, import_react2.default.createElement(ScrollAreaViewport2, { ref }, children), horizontal && import_react2.default.createElement(
...
react/cjs/react-jsx-runtime.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ERZNA3OE.js.map
