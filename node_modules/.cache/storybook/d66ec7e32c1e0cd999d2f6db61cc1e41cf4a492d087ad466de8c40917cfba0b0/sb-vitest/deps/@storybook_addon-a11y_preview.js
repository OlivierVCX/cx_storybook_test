...
// node_modules/@storybook/addon-a11y/dist/_browser-chunks/chunk-JZJ5QO7P.js
...
// node_modules/@storybook/addon-a11y/dist/_browser-chunks/chunk-W2OC36OK.js
var preview_exports = {};
...
var { document } = scope;
var withLinkPaths = __name((results, storyId) => {
...
var run = __name(async (input = DEFAULT_PARAMETERS, storyId) => {
  const axeCore = await import("./axe-625W5KDB.js");
        ...
        if (getIsVitestStandaloneRun()) {
          if (hasViolations && getMode() === "failed") {
            if (!vitestMatchersExtended) {
              const { toHaveNoViolations } = await import("./matchers-ZRZBO4XZ-APEZJC7D.js");
              expect3.extend({ toHaveNoViolations });
