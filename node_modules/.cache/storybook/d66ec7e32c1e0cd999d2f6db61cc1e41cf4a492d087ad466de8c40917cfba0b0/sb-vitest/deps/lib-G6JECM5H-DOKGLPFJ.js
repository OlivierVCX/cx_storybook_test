...
// node_modules/storybook/dist/_node-chunks/lib-G6JECM5H.js
...
var require_main2 = __commonJS({
  "../node_modules/lazy-universal-dotenv/node_modules/dotenv-expand/lib/main.js"(exports, module) {
    ...
    function _interpolate(envValue, environment, config) {
      const lastUnescapedDollarSignIndex = _searchLast(envValue, new RegExp("(?!(?<=\\\\))\\$", "g"));
      if (lastUnescapedDollarSignIndex === -1) return envValue;
      const rightMostGroup = envValue.slice(lastUnescapedDollarSignIndex);
      const matchGroup = new RegExp("((?!(?<=\\\\))\\${?([\\w]+)(?::-([^}\\\\]*))?}?)");
...
var import_app_root_dir = __toESM2(require_lib(), 1);
var import_dotenv = __toESM2(require_main(), 1);
var import_dotenv_expand = __toESM2(require_main2(), 1);
var dotEnvBase = import_path.default.join(import_app_root_dir.default.get(), ".env");
function getEnvironment({ nodeEnv, buildTarget } = {}) {
  let raw = {};
  const stringified = {};
  const webpack = { "process.env": stringified };
  const NODE_ENV = typeof nodeEnv === "undefined" ? "development" : nodeEnv;
...
//# sourceMappingURL=lib-G6JECM5H-DOKGLPFJ.js.map
