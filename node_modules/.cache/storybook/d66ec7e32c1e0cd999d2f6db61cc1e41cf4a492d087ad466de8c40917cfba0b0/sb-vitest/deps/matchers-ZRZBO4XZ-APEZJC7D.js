import {
  __name
} from "./chunk-2FS53TZZ.js";
import "./chunk-256EKJAK.js";

// node_modules/@storybook/addon-a11y/dist/_browser-chunks/matchers-ZRZBO4XZ.js
var ANSI_BACKGROUND_OFFSET = 10;
var wrapAnsi16 = __name((offset = 0) => (code) => `\x1B[${code + offset}m`, "wrapAnsi16");
var wrapAnsi256 = __name((offset = 0) => (code) => `\x1B[${38 + offset};5;${code}m`, "wrapAnsi256");
var wrapAnsi16m = __name((offset = 0) => (red, green, blue) => `\x1B[${38 + offset};2;${red};${green};${blue}m`, "wrapAnsi16m");
var styles = {
  modifier: {
    reset: [0, 0],
...
function assembleStyles() {
  ...
  Object.defineProperties(styles, {
    ...
    hexToAnsi256: {
      value: __name((hex) => styles.rgbToAnsi256(...styles.hexToRgb(hex)), "value"),
      enumerable: false
    },
    ansi256ToAnsi: {
      value(code) {
    ...
    rgbToAnsi: {
      value: __name((red, green, blue) => styles.ansi256ToAnsi(styles.rgbToAnsi256(red, green, blue)), "value"),
      enumerable: false
    },
    hexToAnsi: {
      value: __name((hex) => styles.ansi256ToAnsi(styles.hexToAnsi256(hex)), "value"),
      enumerable: false
    }
  });
  return styles;
...
var applyOptions = __name((object, options = {}) => {
...
var chalkFactory = __name((options) => {
  const chalk2 = __name((...strings) => strings.join(" "), "chalk");
...
var getModelAnsi = __name((model, level2, type, ...arguments_) => {
  if (model === "rgb") {
    if (level2 === "ansi16m") {
...
var createStyler = __name((open, close, parent) => {
  let openAll;
  let closeAll;
  if (parent === void 0) {
    openAll = open;
...
var createBuilder = __name((self, _styler, _isEmpty) => {
  const builder = __name((...arguments_) => applyStyle(builder, arguments_.length === 1 ? "" + arguments_[0] : arguments_.join(" ")), "builder");
...
var applyStyle = __name((self, string) => {
...
var __commonJS = __name((cb, mod) => __name(function __require() {
...
var __toESM = __name((mod, isNodeMode, target) => (target = mod != null ? __create(__getProtoOf(mod)) : {}, __copyProps(isNodeMode || !mod || !mod.__esModule ? __defProp(target, "default", { value: mod, enumerable: true }) : target, mod)), "__toESM");
var require_ansi_styles = __commonJS({
  "node_modules/pretty-format/node_modules/ansi-styles/index.js"(exports, module) {
    "use strict";
    var ANSI_BACKGROUND_OFFSET2 = 10;
    var wrapAnsi2562 = __name((offset = 0) => (code) => `\x1B[${38 + offset};5;${code}m`, "wrapAnsi256");
    var wrapAnsi16m2 = __name((offset = 0) => (red, green, blue) => `\x1B[${38 + offset};2;${red};${green};${blue}m`, "wrapAnsi16m");
    function assembleStyles2() {
      ...
      Object.defineProperties(styles3, {
        ...
        hexToAnsi256: {
          value: __name((hex) => styles3.rgbToAnsi256(...styles3.hexToRgb(hex)), "value"),
          enumerable: false
        }
      });
      return styles3;
...
var require_collections = __commonJS({
  "node_modules/pretty-format/build/collections.js"(exports) {
    ...
    var getKeysOfEnumerableProperties = __name((object, compareKeys) => {
...
var require_AsymmetricMatcher = __commonJS({
  "node_modules/pretty-format/build/plugins/AsymmetricMatcher.js"(exports) {
    ...
    var SPACE = " ";
    var serialize = __name((val, config, indentation, depth, refs, printer) => {
    ...
    var test = __name((val) => val && val.$$typeof === asymmetricMatcher, "test");
    exports.test = test;
    var plugin = {
      serialize,
      test
...
var require_ConvertAnsi = __commonJS({
  "node_modules/pretty-format/build/plugins/ConvertAnsi.js"(exports) {
    ...
    var toHumanReadableAnsi = __name((text) => text.replace((0, _ansiRegex.default)(), (match) => {
      switch (match) {
    ...
    var test = __name((val) => typeof val === "string" && !!val.match((0, _ansiRegex.default)()), "test");
    exports.test = test;
    var serialize = __name((val, config, indentation, depth, refs, printer) => printer(toHumanReadableAnsi(val), config, indentation, depth, refs), "serialize");
    exports.serialize = serialize;
    var plugin = {
      serialize,
      test
...
var require_DOMCollection = __commonJS({
  "node_modules/pretty-format/build/plugins/DOMCollection.js"(exports) {
    ...
    var testName = __name((name) => OBJECT_NAMES.indexOf(name) !== -1 || ARRAY_REGEXP.test(name), "testName");
    var test = __name((val) => val && val.constructor && !!val.constructor.name && testName(val.constructor.name), "test");
    exports.test = test;
    var isNamedNodeMap = __name((collection) => collection.constructor.name === "NamedNodeMap", "isNamedNodeMap");
    var serialize = __name((collection, config, indentation, depth, refs, printer) => {
...
var require_markup = __commonJS({
  "node_modules/pretty-format/build/plugins/lib/markup.js"(exports) {
    ...
    __name(_interopRequireDefault, "_interopRequireDefault");
    var printProps = __name((keys, props, config, indentation, depth, refs, printer) => {
      const indentationNext = indentation + config.indent;
    ...
    var printChildren = __name((children, config, indentation, depth, refs, printer) => children.map((child) => config.spacingOuter + indentation + (typeof child === "string" ? printText(child, config) : printer(child, config, indentation, depth, refs))).join(""), "printChildren");
    exports.printChildren = printChildren;
    var printText = __name((text, config) => {
      const contentColor = config.colors.content;
      return contentColor.open + (0, _escapeHTML.default)(text) + contentColor.close;
    }, "printText");
    exports.printText = printText;
    var printComment = __name((comment, config) => {
      const commentColor = config.colors.comment;
      return `${commentColor.open}<!--${(0, _escapeHTML.default)(comment)}-->${commentColor.close}`;
    }, "printComment");
    exports.printComment = printComment;
    var printElement = __name((type, printedProps, printedChildren, config, indentation) => {
      const tagColor = config.colors.tag;
      return `${tagColor.open}<${type}${printedProps && tagColor.close + printedProps + config.spacingOuter + indentation + tagColor.open}${printedChildren ? `>${tagColor.close}${printedChildren}${config.spacingOuter}${indentation}${tagColor.open}</${type}` : `${printedProps && !config.min ? "" : " "}/`}>${tagColor.close}`;
    }, "printElement");
    exports.printElement = printElement;
    var printElementAsLeaf = __name((type, config) => {
      const tagColor = config.colors.tag;
...
var require_DOMElement = __commonJS({
  "node_modules/pretty-format/build/plugins/DOMElement.js"(exports) {
    ...
    var testHasAttribute = __name((val) => {
      try {
    ...
    var serialize = __name((node, config, indentation, depth, refs, printer) => {
      if (nodeIsText(node)) {
...
var require_Immutable = __commonJS({
  "node_modules/pretty-format/build/plugins/Immutable.js"(exports) {
    ...
    var SPACE = " ";
    var LAZY = "…";
    var printImmutableEntries = __name((val, config, indentation, depth, refs, printer, type) => ++depth > config.maxDepth ? printAsLeaf(getImmutableName(type)) : `${getImmutableName(type) + SPACE}{${(0, _collections.printIteratorEntries)(val.entries(), config, indentation, depth, refs, printer)}}`, "printImmutableEntries");
    ...
    var printImmutableRecord = __name((val, config, indentation, depth, refs, printer) => {
      const name = getImmutableName(val._name || "Record");
      return ++depth > config.maxDepth ? printAsLeaf(name) : `${name + SPACE}{${(0, _collections.printIteratorEntries)(getRecordEntries(val), config, indentation, depth, refs, printer)}}`;
    }, "printImmutableRecord");
    var printImmutableSeq = __name((val, config, indentation, depth, refs, printer) => {
    ...
    var printImmutableValues = __name((val, config, indentation, depth, refs, printer, type) => ++depth > config.maxDepth ? printAsLeaf(getImmutableName(type)) : `${getImmutableName(type) + SPACE}[${(0, _collections.printIteratorValues)(val.values(), config, indentation, depth, refs, printer)}]`, "printImmutableValues");
    var serialize = __name((val, config, indentation, depth, refs, printer) => {
    ...
    exports.serialize = serialize;
    var test = __name((val) => val && (val[IS_ITERABLE_SENTINEL] === true || val[IS_RECORD_SENTINEL] === true), "test");
    exports.test = test;
    var plugin = {
      serialize,
      test
...
var require_ReactElement = __commonJS({
  "node_modules/pretty-format/build/plugins/ReactElement.js"(exports) {
    ...
    function _getRequireWildcardCache(nodeInterop) {
      ...
      return (_getRequireWildcardCache = __name(function(nodeInterop2) {
    ...
    var getChildren = __name((arg, children = []) => {
...
var require_ReactTestComponent = __commonJS({
  "node_modules/pretty-format/build/plugins/ReactTestComponent.js"(exports) {
    ...
    var getPropKeys = __name((object) => {
      const { props } = object;
      return props ? Object.keys(props).filter((key) => props[key] !== void 0).sort() : [];
    }, "getPropKeys");
    var serialize = __name((object, config, indentation, depth, refs, printer) => ++depth > config.maxDepth ? (0, _markup.printElementAsLeaf)(object.type, config) : (0, _markup.printElement)(object.type, object.props ? (0, _markup.printProps)(getPropKeys(object), object.props, config, indentation + config.indent, depth, refs, printer) : "", object.children ? (0, _markup.printChildren)(object.children, config, indentation + config.indent, depth, refs, printer) : "", config, indentation), "serialize");
    exports.serialize = serialize;
...
${indentationNext}`);
    ...
    var getPrintFunctionName = __name((options) => {
    ...
    var getEscapeRegex = __name((options) => {
    ...
    var getEscapeString = __name((options) => {
...
//# sourceMappingURL=matchers-ZRZBO4XZ-APEZJC7D.js.map
