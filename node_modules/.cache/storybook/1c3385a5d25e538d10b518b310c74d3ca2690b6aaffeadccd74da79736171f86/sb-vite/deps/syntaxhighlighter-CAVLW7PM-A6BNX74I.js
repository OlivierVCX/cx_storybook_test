...
// node_modules/storybook/dist/_browser-chunks/syntaxhighlighter-CAVLW7PM.js
...
var require_graphql = __commonJS({
  "../node_modules/refractor/lang/graphql.js"(exports, module) {
    ...
    function graphql2(Prism) {
      ...
      Prism.hooks.add("after-tokenize", __name(function afterTokenizeGraphql(env) {
  ...
  "../node_modules/refractor/lang/jsx.js"(exports, module) {
    ...
    function jsx2(Prism) {
      ...
      (function(Prism2) {
        ...
        var walkTokens = __name(function(tokens) {
          var openedTags = [];
  ...
  "../node_modules/refractor/lang/markup.js"(exports, module) {
    ...
    function markup2(Prism) {
      ...
      Object.defineProperty(Prism.languages.markup.tag, "addInlined", {
         ...
         */
        value: __name(function addInlined(tagName, lang) {
    ...
    var Prism = (function(_self2) {
      ...
      var _ = {
        ...
        util: {
           ...
           * @template T
           */
          clone: __name(function deepClone(o, visited) {
            visited = visited || {};
            var clone;
            var id;
        ...
        languages: {
           ...
           * });
           */
          extend: __name(function(id, redef) {
          ...
          DFS: __name(function DFS(o, callback, type, visited) {
            visited = visited || {};
      ...
      __name(Token, "Token");
      Token.stringify = __name(function stringify(o, language) {
        if (typeof o == "string") {
          return o;
        }
        if (Array.isArray(o)) {
...
var checkForListedLanguage_default = __name(function(astGenerator, language) {
...
function processLines(codeTree, wrapLines, lineProps, showLineNumbers, showInlineLineNumbers, startingLineNumber, largestLineNumber, lineNumberStyle, wrapLongLines) {
  ...
  var _loop = __name(function _loop2() {
    var node = tree[index];
...
function highlight_default(defaultAstGenerator, defaultStyle) {
  return __name(function SyntaxHighlighter3(_ref7) {
...
var UnstyledScroller = __name(({ children, className }) => import_react.default.createElement(ScrollArea2, { horizontal: true, vertical: true, className }, children), "UnstyledScroller");
...
var processLineNumber = __name((row) => {
...
var defaultRenderer2 = __name(({ rows, stylesheet, useInlineStyles }) => {
...
var wrapRenderer = __name((renderer, showLineNumbers) => {
  if (!showLineNumbers) {
    return renderer;
  }
  if (renderer) {
...
var SyntaxHighlighter2 = __name(({
  ...
  const [highlightableCode, setHighlightableCode] = (0, import_react.useState)("");
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(Scroller, null, import_react.default.createElement(
      prism_light_default,
      {
...
//# sourceMappingURL=syntaxhighlighter-CAVLW7PM-A6BNX74I.js.map
