import {
  ...
  __toESM as __toESM2,
  getControlId
} from "./chunk-HYQ43CP2.js";
import {
  Form,
  MarkupIcon,
  TooltipNote,
  WithTooltip
} from "./chunk-6GBJOKTH.js";
import "./chunk-N74QY26N.js";
import "./chunk-XMEDLKEC.js";
import {
  styled
} from "./chunk-DOC4BB32.js";
import "./chunk-C2UDVOTZ.js";
import "./chunk-LJWBQW54.js";
import "./chunk-W3AQUOD7.js";
import "./chunk-52GMUAQK.js";
import "./chunk-DEHUAR6J.js";
import "./chunk-7XPZJPWH.js";
import "./chunk-7LJ2A7BE.js";
import "./chunk-EA2IITB3.js";
import "./chunk-DYIBIZZ4.js";
import "./chunk-QFCKH4KW.js";
import "./chunk-YKG2Z2PB.js";
import {
  require_react
} from "./chunk-5KY3CYEV.js";
import {
  __toESM
} from "./chunk-PR4QN5HX.js";

// node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-64QXVMR3.js
...
var require_conversions = __commonJS({
  "../../node_modules/color-convert/conversions.js"(exports, module) {
    ...
    convert2.rgb.hsv = function(rgb) {
      ...
      const diffc = __name(function(c2) {
...
var require_color_convert = __commonJS({
  "../../node_modules/color-convert/index.js"(exports, module) {
    ...
    function wrapRaw(fn) {
      const wrappedFn = __name(function(...args) {
        const arg0 = args[0];
...
var import_color_convert = __toESM2(require_color_convert(), 1);
function debounce(func, debounceMs, { signal, edges } = {}) {
  ...
  const debounced = __name(function(...args) {
    if (signal?.aborted) {
      return;
    }
    pendingThis = this;
...
function partialImpl(func, placeholder, ...partialArgs) {
  const partialed = __name(function(...providedArgs) {
...
function partialRightImpl(func, placeholder, ...partialArgs) {
  const partialedRight = __name(function(...providedArgs) {
...
__name(c, "c");
function i(e2) {
  var t2 = (0, import_react2.useRef)(e2), n2 = (0, import_react2.useRef)(function(e3) {
    t2.current && t2.current(e3);
  });
  return t2.current = e2, n2.current;
}
__name(i, "i");
var s = __name(function(e2, r2, t2) {
  return void 0 === r2 && (r2 = 0), void 0 === t2 && (t2 = 1), e2 > t2 ? t2 : e2 < r2 ? r2 : e2;
}, "s");
var f = __name(function(e2) {
  return "touches" in e2;
}, "f");
var v = __name(function(e2) {
  return e2 && e2.ownerDocument.defaultView || self;
}, "v");
var d = __name(function(e2, r2, t2) {
...
var h = __name(function(e2) {
  !f(e2) && e2.preventDefault();
}, "h");
var m = import_react2.default.memo(function(o2) {
  var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = (0, import_react2.useRef)(null), g2 = i(a2), p2 = i(l2), b2 = (0, import_react2.useRef)(null), _2 = (0, import_react2.useRef)(false), x2 = (0, import_react2.useMemo)(function() {
  ...
  return (0, import_react2.useEffect)(function() {
    return H2;
  }, [H2]), import_react2.default.createElement("div", u({}, s2, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m2, onKeyDown: E2, tabIndex: 0, role: "slider" }));
});
var g = __name(function(e2) {
  return e2.filter(Boolean).join(" ");
}, "g");
var p = __name(function(r2) {
  var t2 = r2.color, n2 = r2.left, o2 = r2.top, a2 = void 0 === o2 ? 0.5 : o2, l2 = g(["react-colorful__pointer", r2.className]);
  return import_react2.default.createElement("div", { className: l2, style: { top: 100 * a2 + "%", left: 100 * n2 + "%" } }, import_react2.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t2 } }));
}, "p");
var b = __name(function(e2, r2, t2) {
  return void 0 === r2 && (r2 = 0), void 0 === t2 && (t2 = Math.pow(10, r2)), Math.round(t2 * e2) / t2;
}, "b");
var _ = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) };
var x = __name(function(e2) {
  return L(C(e2));
}, "x");
var C = __name(function(e2) {
...
var N = __name(function(e2) {
  var r2 = e2.s, t2 = e2.l;
  return { h: e2.h, s: (r2 *= (t2 < 50 ? t2 : 100 - t2) / 100) > 0 ? 2 * r2 / (t2 + r2) * 100 : 0, v: t2 + r2, a: e2.a };
}, "N");
var w = __name(function(e2) {
  return K(I(e2));
}, "w");
var y = __name(function(e2) {
...
var q = __name(function(e2) {
  var r2 = y(e2);
  return "hsl(" + r2.h + ", " + r2.s + "%, " + r2.l + "%)";
}, "q");
var k = __name(function(e2) {
  var r2 = y(e2);
  return "hsla(" + r2.h + ", " + r2.s + "%, " + r2.l + "%, " + r2.a + ")";
}, "k");
var I = __name(function(e2) {
...
var S = import_react2.default.memo(function(r2) {
  var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
  return import_react2.default.createElement("div", { className: o2 }, import_react2.default.createElement(m, { onMove: __name(function(e2) {
    n2({ h: 360 * e2.left });
  }, "onMove"), onKey: __name(function(e2) {
    n2({ h: s(t2 + 360 * e2.left, 0, 360) });
  }, "onKey"), "aria-label": "Hue", "aria-valuenow": b(t2), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react2.default.createElement(p, { className: "react-colorful__hue-pointer", left: t2 / 360, color: q({ h: t2, s: 100, v: 100, a: 1 }) })));
});
var T = import_react2.default.memo(function(r2) {
  var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q({ h: t2.h, s: 100, v: 100, a: 1 }) };
  return import_react2.default.createElement("div", { className: "react-colorful__saturation", style: o2 }, import_react2.default.createElement(m, { onMove: __name(function(e2) {
    n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
  }, "onMove"), onKey: __name(function(e2) {
    n2({ s: s(t2.s + 100 * e2.left, 0, 100), v: s(t2.v - 100 * e2.top, 0, 100) });
  }, "onKey"), "aria-label": "Color", "aria-valuetext": "Saturation " + b(t2.s) + "%, Brightness " + b(t2.v) + "%" }, import_react2.default.createElement(p, { className: "react-colorful__saturation-pointer", top: 1 - t2.v / 100, left: t2.s / 100, color: q(t2) })));
});
var F = __name(function(e2, r2) {
  if (e2 === r2) return true;
  for (var t2 in e2) if (e2[t2] !== r2[t2]) return false;
  return true;
}, "F");
var P = __name(function(e2, r2) {
  return e2.replace(/\s/g, "") === r2.replace(/\s/g, "");
}, "P");
var X = __name(function(e2, r2) {
  return e2.toLowerCase() === r2.toLowerCase() || F(C(e2), C(r2));
}, "X");
function Y(e2, t2, l2) {
  var u2 = i(l2), c2 = (0, import_react2.useState)(function() {
    return e2.toHsva(t2);
  }), s2 = c2[0], f2 = c2[1], v2 = (0, import_react2.useRef)({ color: t2, hsva: s2 });
  (0, import_react2.useEffect)(function() {
    if (!e2.equal(t2, v2.current.color)) {
      var r2 = e2.toHsva(t2);
      v2.current = { hsva: r2, color: t2 }, f2(r2);
    }
  }, [t2, e2]), (0, import_react2.useEffect)(function() {
    var r2;
    F(s2, v2.current.hsva) || e2.equal(r2 = e2.fromHsva(s2), v2.current.color) || (v2.current = { hsva: s2, color: r2 }, u2(r2));
  }, [s2, e2, u2]);
  var d2 = (0, import_react2.useCallback)(function(e3) {
    f2(function(r2) {
...
__name(Y, "Y");
var R;
var V = "undefined" != typeof window ? import_react2.useLayoutEffect : import_react2.useEffect;
var $ = __name(function() {
...
var U = __name(function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = void 0 === a2 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0, import_react2.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return import_react2.default.createElement("div", u({}, s2, { ref: f2, className: m2 }), import_react2.default.createElement(T, { hsva: d2, onChange: h2 }), import_react2.default.createElement(S, { hue: d2.h, onChange: h2, className: "react-colorful__last-control" }));
}, "U");
var W = { defaultColor: "000", toHsva: x, fromHsva: __name(function(e2) {
  return w({ h: e2.h, s: e2.s, v: e2.v, a: 1 });
}, "fromHsva"), equal: X };
var Z = __name(function(r2) {
  return import_react2.default.createElement(U, u({}, r2, { colorModel: W }));
}, "Z");
var ee = __name(function(r2) {
  ...
  return import_react2.default.createElement("div", { className: l2 }, import_react2.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), import_react2.default.createElement(m, { onMove: __name(function(e2) {
    o2({ a: e2.left });
  }, "onMove"), onKey: __name(function(e2) {
    o2({ a: s(n2.a + e2.left) });
  }, "onKey"), "aria-label": "Alpha", "aria-valuetext": u2 + "%", "aria-valuenow": u2, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react2.default.createElement(p, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
}, "ee");
var re = __name(function(t2) {
  var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = void 0 === a2 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, ["className", "colorModel", "color", "onChange"]), f2 = (0, import_react2.useRef)(null);
  Q(f2);
  var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
  return import_react2.default.createElement("div", u({}, s2, { ref: f2, className: m2 }), import_react2.default.createElement(T, { hsva: d2, onChange: h2 }), import_react2.default.createElement(S, { hue: d2.h, onChange: h2 }), import_react2.default.createElement(ee, { hsva: d2, onChange: h2, className: "react-colorful__last-control" }));
}, "re");
var le = { defaultColor: "hsla(0, 0%, 0%, 1)", toHsva: H, fromHsva: k, equal: P };
var ue = __name(function(r2) {
  return import_react2.default.createElement(re, u({}, r2, { colorModel: le }));
}, "ue");
var Ee = { defaultColor: "rgba(0, 0, 0, 1)", toHsva: z, fromHsva: __name(function(e2) {
  var r2 = I(e2);
  return "rgba(" + r2.r + ", " + r2.g + ", " + r2.b + ", " + r2.a + ")";
}, "fromHsva"), equal: P };
var He = __name(function(r2) {
  return import_react2.default.createElement(re, u({}, r2, { colorModel: Ee }));
}, "He");
...
var Swatch = __name(({ value, style, ...props }) => {
...
var parseRgb = __name((value) => {
  ...
  return {
    ...
    [
      "hex"
      /* HEX */
    ]: `#${import_color_convert.default.rgb.hex([r2, g2, b2]).toLowerCase()}`
  };
}, "parseRgb");
var parseHsl = __name((value) => {
  ...
  return {
    ...
    [
      "hex"
      /* HEX */
    ]: `#${import_color_convert.default.hsl.hex([h2, s2, l2]).toLowerCase()}`
  };
}, "parseHsl");
var parseHexOrKeyword = __name((value) => {
...
var getRealValue = __name((value, color, colorSpace) => {
...
var useColorInput = __name((initialValue, onChange) => {
  const [value, setValue] = (0, import_react.useState)(initialValue || "");
  const [color, setColor] = (0, import_react.useState)(() => parseValue(value));
  const [colorSpace, setColorSpace] = (0, import_react.useState)(
  ...
  const realValue = (0, import_react.useMemo)(
  ...
  const cycleColorSpace = (0, import_react.useCallback)(() => {
...
var id = __name((value) => value.replace(/\s*/, "").toLowerCase(), "id");
var usePresets = __name((presetColors, currentColor, colorSpace) => {
  const [selectedColors, setSelectedColors] = (0, import_react.useState)(currentColor?.valid ? [currentColor] : []);
  (0, import_react.useEffect)(() => {
  ...
  const addPreset = (0, import_react.useCallback)(
    (color) => {
      if (!color?.valid) {
        return;
      }
...
var ColorControl = __name(({
  ...
  const debouncedOnChange = (0, import_react.useCallback)(debounce(onChange, 200), [onChange]);
  ...
  return import_react.default.createElement(Wrapper, { "aria-readonly": readonly }, import_react.default.createElement(
    PickerTooltip,
    {
      startOpen,
      ...
      tooltip: import_react.default.createElement(TooltipContent, null, import_react.default.createElement(
        Picker,
        {
          color: realValue === "transparent" ? "#000000" : realValue,
          ...{ onChange: updateValue, onFocus, onBlur }
        }
      ), presets.length > 0 && import_react.default.createElement(Swatches, null, presets.map((preset, index) => import_react.default.createElement(
        WithTooltip,
        {
          key: `${preset?.value || index}-${index}`,
          hasChrome: false,
          tooltip: import_react.default.createElement(Note, { note: preset?.keyword || preset?.value || "" })
        },
    ...
    import_react.default.createElement(Swatch, { value: realValue, style: { margin: 4 } })
  ), import_react.default.createElement(
    Input,
    {
  ...
  ), value ? import_react.default.createElement(ToggleIcon, { onClick: cycleColorSpace }) : null);
}, "ColorControl");
...
//# sourceMappingURL=Color-64QXVMR3-6ZR3WH34.js.map
