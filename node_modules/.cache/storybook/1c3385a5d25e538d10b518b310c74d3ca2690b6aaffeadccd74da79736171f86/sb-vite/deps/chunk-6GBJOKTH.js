...
var LazySyntaxHighlighter = (0, import_react5.lazy)(async () => {
  const { SyntaxHighlighter: SyntaxHighlighter2 } = await import("./syntaxhighlighter-CAVLW7PM-A6BNX74I.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react5.lazy)(async () => {
  const [{ SyntaxHighlighter: SyntaxHighlighter2 }, { formatter }] = await Promise.all([
    import("./syntaxhighlighter-CAVLW7PM-A6BNX74I.js"),
    import("./formatter-OMEEQ6HG-VFFQJ7A3.js")
  ]);
  if (languages.length > 0) {
    languages.forEach((args) => {
      SyntaxHighlighter2.registerLanguage(...args);
...
var LazyWithTooltip = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-P65RYXBB.js").then((mod) => ({ default: mod.WithTooltip }))
);
...
var LazyWithTooltipPure = (0, import_react31.lazy)(
  () => import("./WithTooltip-SK46ZJ2J-P65RYXBB.js").then((mod) => ({ default: mod.WithTooltipPure }))
);
...
//# sourceMappingURL=chunk-6GBJOKTH.js.map
